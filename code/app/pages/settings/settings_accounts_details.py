...
def _action_buttons(signal_asset_id: str) -> html.Div:
    return AlphaRow([
        AlphaCol(AlphaButton("✏️", button_id={"type": "edit-config", "index": signal_asset_id}, style={"backgroundColor": "#FFC107", "width": "40px"}).render(), width="auto"),
        AlphaCol(AlphaButton("🗑️", button_id={"type": "delete-config", "index": signal_asset_id}, style={"backgroundColor": "#DC3545", "width": "40px"}).render(), width="auto"),
    ])
...
def build_table(uid: str) -> html.Table:
    ...
    headers = [
        "Signal Asset ID", "Platform Asset ID", "Entry Stagger", "Size Stagger",
        "# Staggers", "Size", "Decimals", "Actions"
    ]
