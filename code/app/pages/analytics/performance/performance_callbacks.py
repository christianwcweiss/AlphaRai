...
def render_performance_content(  # pylint: disable=too-many-arguments, too-many-positional-arguments
    ...
    """Render the performance content for the analytics page."""
    ...
    return (
        AlphaRow(
            [
                AlphaCol(
                    ExpectancyOverTimeMolecule(data_frame=expectancy_df).render(groups=groups, chart_mode=chart_mode),
                    xs=12,
                    sm=12,
                    md=12,
                    lg=12,
