...
class SortinoRatioOverTimeMolecule(Molecule):  # pylint: disable=too-few-public-methods
    """A molecule that renders the Sortino Ratio Over Time chart."""
    ...
    def _render_card_header(self):
        return AlphaCardHeader(
            [
                html.Div(
                    [html.H5("SORTINO RATIO OVER TIME")],
                    style={
                        "display": "flex",
        ...
        return html.Div(
            children=[
                dcc.Graph(
                    ...
                    ).plot(x_col="time", y_col="sortino", group_by="account_id"),
