...
class TestDataFeatureSortinoRatio:
    def test_multiple_columns_with_different_parameters(self) -> None:
        ...
        features = [
            DataFeatureSortinoRatio(direction=direction, annual_risk_free_percent=free_percent, rolling_window_bars=bars)
    ...
    @pytest.mark.parametrize(
        ...
        [
            (
                ...
                2.0,
                60,
                [-0.6816, -0.5922, -0.5499, -0.5327, -0.6027, -0.5496, -0.5356, -0.602, -0.6789, -0.6209, -0.5434,
                 -0.4931, -0.4724, -0.365, -0.4227, -0.4187, -0.4149, -0.4114, -0.4078, -0.4218],
            ),
            (
                "btcusd_240.csv",
                ...
                3.0,
                100,
                [-0.368, -0.4107, -0.3913, -0.3507, -0.3288, -0.3235, -0.3396, -0.3641, -0.3871, -0.3772, -0.4303,
                 -0.418, -0.4483, -0.4353, -0.3862, -0.2496, -0.2946, -0.2822, -0.3157, -0.3392],
            ),
        ],
    )
