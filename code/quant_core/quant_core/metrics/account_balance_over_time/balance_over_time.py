...
class AccountBalanceOverTime(TradeMetricOverTime):
    ...
    def _set_initial_balances(self, data_frame: pd.DataFrame, group_by_account_id: bool) -> pd.DataFrame:
    ...
    def calculate(
        ...
        balance_df = self._set_initial_balances(balance_df, group_by_account_id)
